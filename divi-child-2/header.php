...
?>
	...
	<?php ob_start(); ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			@media only screen and (max-width: 981px){
				.logo-mobil{
					content: url(https://kogle.celinaamalie.dk/wp-content/uploads/2020/03/Kogle-mobil-logo-1.png);
					display: block;
				...
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" class="logo-mobil" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
						<img src="https://kogle.celinaamalie.dk/wp-content/uploads/2020/03/kogle-logo.png" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" class="logo-left" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
						<img src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" class="logo-mid" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '34' ) ); ?>" />
					</a>
				</div>
			<?php
