<?php
    $pc_checked = '';
    $performance_icon = $this->OCVCURI.'/assets/images/performance.png';
    $performance_icon_2x = $this->OCVCURI.'/assets/images/performance@2x.png 2x';    
    $performance_icon_active = $this->OCVCURI.'/assets/images/performance-active@1x.png';
    $performance_icon_2x_active = $this->OCVCURI.'/assets/images/performance-active@2x.png 2x';
...
<div id="onestaging-clonepage-wrapper">
    ...
    <div class="wrap onecom-staging-wrap">
        ...
        <h2 class="one-logo">
            ...
            <div class="textright">
                <img src="<?php echo $this->OCVCURI.'/assets/images/one.com-logo.png' ?>" alt="One.com"
                    srcset="<?php echo $this->OCVCURI.'/assets/images/one.com-logo@2x.png 2x' ?>" />
            </div>
        </h2>
        <div class="wrap_inner inner one_wrap">
            <div class="one-card one-card-performance">
                <div class="one-card-inline-block one-card-align-left onecom-staging-logo">
                    <img id="oc-performance-icon" src="<?php echo $performance_icon ?>" alt="One.com"
