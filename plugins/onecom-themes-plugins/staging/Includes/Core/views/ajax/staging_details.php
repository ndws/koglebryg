        ...
        <div id="staging_entry">
            ...
            <div class="one-staging-actions card-3">
                ...
                <br><br>
                <?php 
                echo $rebuild_btn = '<button class="one-button btn button_1 one-button-update-staging" data-staging-id="" data-dialog-id="staging-update-confirmation" data-title="'.__( 'Are you sure?', 'onecom-wp' ).'" data-width="450" data-height="195">'. __( 'Rebuild Staging', 'onecom-wp' ).'</button>'; 

                //echo apply_filters('oc_staging_button_rebuild', $rebuild_btn);
                
                $delete_btn = '<a href="javascript:;" class="staging-trash one-button-delete-staging"  title="'. __("Delete Staging", "onecom-wp").'" data-title="'.__( 'Are you sure?', 'onecom-wp' ).'" data-dialog-id="staging-delete" data-width="450" data-height="155"><span class="dashicons dashicons-trash"></span> '.__("Delete Staging", "onecom-wp").'</a>';
