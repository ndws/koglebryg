                ...
                <?php endif; ?>
                        ...
                        <div class="one-card-staging-create-info">
                            ...
                            <div class="one-card-action">
                                <?php
                                $create_btn = '<input type="button" value="' . __( 'Create staging site', 'onecom-wp' ) . '" class="one-button btn button_1 one-button-create-staging no-left-margin no-right-margin" />';
